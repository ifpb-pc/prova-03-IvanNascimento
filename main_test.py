...
@pytest.mark.parametrize(
    ...
    [
        (
            {"João Pessoa": 432, "Campina Grande": 325, "Santa Rita": 68, "Patos": 289},
            ["João Pessoa", "Campina Grande", "Patos"],
        ),
        (
            {"Bayeux": 54, "Sousa": 178, "Cajazeiras": 201, "Cabedelo": 45},
            ["Sousa", "Cajazeiras"],
        ),
...
@pytest.mark.parametrize(
    "lista1, lista2, soma_esperada, resultado_esperado",
    [
